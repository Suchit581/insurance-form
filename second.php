<?php
    ...
    $age=$diff->y;
    $term=10;
    $sql="SELECT * FROM table_1 WHERE Coverage_Term=10 AND Gender='$gen' AND Smoker_Status='$smoke'";
  ...
  <body>
    ...
    <div class="container-fluid mt-5 pl-5 pr-5">
            ...
            <div class="col text-center">
                ...
                <div class="">
                    <div class="range-slider">
                      ...
                      <input id="rs-range-line" class="rs-range" type="range" value="25000" min="25000" max="500000">
                    </div>
        ...
        <?php
            ...
            {
        ?>
        <div class="row w-100 align-items-center mt-4 mb-4">
            <div class="border bg-light border-primary rounded w-100 align-items-center">
                ...
                <div class="container-fluid mt-4">
                    <div class="row">
                        <div class="col text-center">
                            <span class="h3"><?php echo $row[1] ?></span>
                        ...
                        <div class="col text-center">
                            <p class="h1 mb-0">$<?php echo $row[7] ?></p>
                            <p class="mt-0">per month</p>
                        </div>
                        <div class="col text-center">
                            <a href="apply.php?policy=<?php echo $row[0] ?>"><button class="btn btn-primary rounded-cirlce">
                                APPLY NOW</button></a>
                            </button>
                        </div>
                    </div>
